...
using ba360lib.com.brokeragent360.crm;
...
namespace ba360lib
{
    public class BA360_lib
    {
        ...
        string UserName = "web_service_admin", Password = "crmWeb@ba360_2016"; //URL = "http://streamscrm.com/custom/service/v4_custom/soap.php?wsdl";
        ...
        public string InsertLeadDetails(LeadInfo lead_info, string Handle)
        {
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(_connString))
                {
                    ...
                    if (Handle == "Insert")
                    {
                        cmd.Parameters.Add("@ISBackend", SqlDbType.Bit).Value = false;  //0
                    }
                    else
                    {
                        cmd.Parameters.Add("@ISBackend", SqlDbType.Bit).Value = true;  //1
                    }
